 ...
 * @version 1.0.0
 */
public class LessonSetSpec extends PzSimpleSpecification<LessonSet, LessonInfo> {

    public LessonSetSpec(LessonInfo condition) {
        super(condition);
    }

    @Override
    protected void addCondition(QueryWraper<LessonSet> queryWraper) {
        ...
        addEqualsCondition(queryWraper, "setId", "tag.id");
